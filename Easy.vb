...
Public Class Easy
    Public rdmNum1To9 As Integer
    Public isGameRunning As Boolean = True
    Public numTry As Integer = 3
    ...
    'RANDOM
    Private Sub RandomNumber1To9()
        ' Create a new instance of the Random class.
        Dim rand As New Random()

        ' Generate a random number between 1 and 9.
        rdmNum1To9 = rand.Next(1, 10) ' The upper bound is exclusive.

        'Display the random number for Testing purpose
        label_random_number.Text = rdmNum1To9.ToString()
    End Sub
    ...
    Private Sub NumberButton_Click(sender As Object, e As EventArgs)
        If isGameRunning = True Then
            ...
            If Integer.TryParse(buttonNumberString, buttonNumber) Then
                ...
                If buttonNumber = rdmNum1To9 Then
