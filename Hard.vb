Public Class Hard
    ...
    Public rdmNum1To100 As Integer
    Public isGameRunning As Boolean = True
    Public numTry As Integer = 10
    ...
    Public Sub New()
        ...
        For i As Integer = 1 To 100
            ...
            If button IsNot Nothing Then
                AddHandler button.Click, AddressOf NumberButton_Click
            End If
        Next
    ...
    'RANDOM
    Private Sub RandomNumber1To100()
        ' Create a new instance of the Random class.
        Dim rand As New Random()

        ' Generate a random number between 1 and 9.
        rdmNum1To100 = rand.Next(1, 101) ' The upper bound is exclusive.

        'Display the random number for Testing purpose
        label_random_number.Text = rdmNum1To100.ToString()
    End Sub
    ...
    Private Sub NumberButton_Click(sender As Object, e As EventArgs)
        If isGameRunning = True Then
            ...
            Dim buttonNumberString As String = clickedButton.Name.Substring(6)
            ...
            If Integer.TryParse(buttonNumberString, buttonNumber) Then
                ...
                If buttonNumber = rdmNum1To100 Then
                    ...
                    clickedButton.Font = New Font(clickedButton.Font.FontFamily, 8, FontStyle.Bold)
    ...
    Private Sub Btn_play_again_Click(sender As Object, e As EventArgs) Handles btn_play_again.Click
        ...
        Else
            ...
            ' Reset the buttons
            For i As Integer = 1 To 100
                Dim button As Button = TryCast(Me.Controls($"Button{i}"), Button)
                If button IsNot Nothing Then
                    ResetButton(button, originalFont, originalBackColor)
                End If
            Next
